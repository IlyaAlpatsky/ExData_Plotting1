...
# create a plot Global_Active_power by datetime line with respect to x-label, y-label and main title
plot(hh_subset_data$Datetime,hh_subset_data$Global_active_power,main="",xlab="",ylab = "Global Active Power (kilowatts)",type="l")
